...
import { faCircleInfo,faGear,faArrowsRotate } from '@fortawesome/free-solid-svg-icons';
...
function App() {
  ...
  return (
    <>
      ...
      <FontAwesomeIcon icon={faArrowsRotate} className="ri-loop-right-line text-gray-300 px-7" onClick={()=>setCount(0)} />
      </div>
